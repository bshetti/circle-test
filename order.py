...
#There are three different authmodes -
#Mode 0 - standalone mode no auth
#Mode 1 - checks for authentication in the header
#Mode 2 - is a local version where 'user' service is local and test with 'eric' user name
